...
(custom-set-variables
 ...
 '(package-selected-packages
   '(auctex badwolf-theme darkroom dired-git-info doom-modeline
	    emmet-mode fireplace flycheck flyspell-correct-helm focus
	    magit olivetti org-bullets rainbow-delimiters
	    selectric-mode writeroom-mode)))
(custom-set-faces
